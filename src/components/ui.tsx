...
import { formatSol, formatUsd, lamportsToSol } from "@/lib/money";
...
/*
 * The money formatters live in `@/lib/money` so they can be unit tested — this
 * file cannot be imported by the test runner. Re-exported here because every
 * component already reaches for them through `@/components/ui`, and imported
 * as well because the components below this line use `formatSol` themselves.
 */
export { formatSol, formatUsd, lamportsToSol };
